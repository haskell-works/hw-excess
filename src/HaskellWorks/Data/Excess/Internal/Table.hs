...
tableWord8Excess0Lo = DVS.constructN (256 * 8) go
...
tableWord8Excess0Ex = DVS.constructN (256 * 8) go
  where go :: DVS.Vector Int8 -> Int8
...
tableWord8Excess0Hi = DVS.constructN (256 * 8) go
  where go :: DVS.Vector Int8 -> Int8
...
tableWord8Excess1Lo = DVS.constructN (256 * 8) go
  where go :: DVS.Vector Int8 -> Int8
...
tableWord8Excess1Ex = DVS.constructN (256 * 8) go
  where go :: DVS.Vector Int8 -> Int8
...
tableWord8Excess1Hi = DVS.constructN (256 * 8) go
  where go :: DVS.Vector Int8 -> Int8
